    ...
    <div className='flex flex-col bg-iris-50 min-h-screen'>
      ...
      <footer className='relative pt-8 pb-4 bg-iris-200'>
        <div className='absolute -top-5 h-10 w-full flex flex-row items-center'>
          ...
          <img src={irisFlower} alt='Iris flower' className='h-full bg-white rounded-full shadow-md' />
          <div className='grow h-1 bg-iris-600' />
        </div>

        <div className='flex flex-col items-center'>
          <span><span className='font-bold text-xl'>Iris</span> • <AriaLink className='font-sans external' href='https://cs.ucsb.edu/'>CS @ UCSB</AriaLink></span>
          <p className='text-sm text-center my-1'>
            Please report accessibility issues or other complaints by emailing <AriaLink href='mailto:contact@seki.pw' className='external'>contact@seki.pw</AriaLink>.
          </p>
